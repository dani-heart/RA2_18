...
class BuilderStub:
    # Esse é um Builder MINIMO que registra chamadas e retorna strings descritivas para o tester
    def __init__(self):
        self.chamadas: list = []
...
# Caminho feliz 
# Aqui a gente testa o minimo para funcionar
...
# Caminho feliz
# Testes para as expressões aritméticas
